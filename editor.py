...
with gr.Blocks() as User_Interface_GUI:
    with gr.Row():
        ...
        with gr.Column():
            ...
            def on_save_button_click(question_text,answer_text):
                ...
                output_text_field.value = f"JSON saved to {filename}"

            save_json_shareGPT.click(on_save_button_click,[question_text_field,answer_text_field])
